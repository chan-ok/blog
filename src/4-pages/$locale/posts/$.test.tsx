...
// ScrollProgressBar 모킹
vi.mock("@/5-shared/components/scroll-progress-bar", () => ({
  default: () => <div data-testid="scroll-progress-bar" />,
}));

// PostNavigation 모킹
vi.mock("@/2-features/post/ui/post-navigation", () => ({
  default: () => <nav data-testid="post-navigation">Navigation</nav>,
  PostNavigationSkeleton: () => <div>Loading nav...</div>,
}));
