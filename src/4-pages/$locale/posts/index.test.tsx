...
// PostSearchInput 모킹 (useNavigate가 RouterProvider 필요하므로)
vi.mock("@/2-features/post/ui/post-search-input", () => ({
  default: () => <div data-testid="post-search-input">Search Input</div>,
}));
