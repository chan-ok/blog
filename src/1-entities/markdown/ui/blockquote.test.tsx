...
describe('Unit 테스트 - 기본 blockquote 렌더링', () => {
   ...
   */
  it.skip('일반 인용문을 blockquote 태그로 렌더링해야 한다', () => {
    ...
    const blockquote = screen.getByText('일반 인용문입니다.').closest('blockquote');
   ...
   */
  it.skip('시맨틱 blockquote 태그를 사용해야 한다', () => {
    const { unmount, container } = render(
      <Blockquote>
        <p>인용문</p>
      </Blockquote>
...
describe('Unit 테스트 - Callout 타입별 렌더링', () => {
   ...
   */
  it.skip('[!INFO] Callout을 파란 배경과 Info 아이콘으로 렌더링해야 한다', () => {
    const { unmount, container } = render(
      <Blockquote>
        <p>[!INFO]</p>
        <p>정보 메시지입니다.</p>
   ...
   */
  it.skip('[!WARNING] Callout을 노란/주황 배경과 AlertTriangle 아이콘으로 렌더링해야 한다', () => {
    const { unmount, container } = render(
      <Blockquote>
        <p>[!WARNING]</p>
        <p>경고 메시지입니다.</p>
    ...
    const callout = container.querySelector('[class*="yellow"], [class*="orange"]');
    expect(callout).toBeInTheDocument();
   ...
   */
  it.skip('[!DANGER] Callout을 빨간 배경과 AlertOctagon 아이콘으로 렌더링해야 한다', () => {
    const { unmount, container } = render(
      <Blockquote>
        <p>[!DANGER]</p>
        <p>위험 메시지입니다.</p>
   ...
   */
  it.skip('[!SUCCESS] Callout을 초록 배경과 CheckCircle 아이콘으로 렌더링해야 한다', () => {
    const { unmount, container } = render(
      <Blockquote>
        <p>[!SUCCESS]</p>
        <p>성공 메시지입니다.</p>
...
describe('Unit 테스트 - 커스텀 제목 및 엣지 케이스', () => {
   ...
   */
  it.skip('커스텀 제목이 있을 때 해당 제목을 표시해야 한다', () => {
    const { unmount } = render(
      <Blockquote>
        <p>[!INFO] 중요한 정보</p>
        <p>본문 내용입니다.</p>
   ...
   */
  it.skip('알 수 없는 Callout 타입은 일반 blockquote로 폴백해야 한다', () => {
    const { unmount, container } = render(
      <Blockquote>
        <p>[!UNKNOWN]</p>
        <p>알 수 없는 타입입니다.</p>
   ...
   */
  it.skip('빈 blockquote도 크래시하지 않고 렌더링해야 한다', () => {
   ...
   */
  it.skip('본문 없이 제목만 있는 Callout도 렌더링해야 한다', () => {
    const { unmount } = render(
      <Blockquote>
        <p>[!INFO]</p>
      </Blockquote>
...
describe('Unit 테스트 - 다크모드 및 접근성', () => {
   ...
   */
  it.skip('시맨틱 blockquote 태그로 접근성을 제공해야 한다', () => {
    const { unmount, container } = render(
      <Blockquote>
        <p>인용문</p>
      </Blockquote>
   ...
   */
  it.skip('Callout에 적절한 접근성 속성이 적용되어야 한다', () => {
    const { unmount, container } = render(
      <Blockquote>
        <p>[!INFO]</p>
        <p>정보</p>
...
describe('Property-Based 테스트 - 임의 children 조합', () => {
   ...
   * 기대 결과: 모든 경우에 렌더링 성공
   */
  it.skip('임의의 children에서 크래시하지 않아야 한다', () => {
   ...
   * 기대 결과: 모든 p 태그가 렌더링됨
   */
  it.skip('여러 children 요소를 올바르게 렌더링해야 한다', () => {
   ...
   */
  it.skip('모든 Callout 타입에서 크래시하지 않아야 한다', () => {
