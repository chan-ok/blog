...
> **이력 문서:** 아래 작업 현황과 기술 설명에는 작성 당시 상태가 포함되어 있습니다. 현재 설치·구조 기준은 [README](../../README.md)와 [아키텍처 가이드](../architecture.md)를 확인하세요.
...
이 문서는 프로젝트의 주요 의사결정, 작업 진행 상황, 회고 기록을 관리합니다. 프로젝트가 변화해 온 과정과 기록 당시 상태를 한눈에 파악할 수 있는 이력 문서입니다.
