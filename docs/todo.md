...
- [x] 댓글 시스템 선택 (utterances vs giscus) → Giscus 선택 (2025-12-14 완료)
- [x] 설정 및 통합 (2025-12-14 완료)
...
- [ ] Posts 페이지 E2E 테스트
- [ ] 언어 전환 E2E 테스트
- [x] 주요 컴포넌트 유닛 테스트 (Button 컴포넌트 완료 - 2025-12-13)
- [x] Storybook 스토리 추가 (Button 컴포넌트 완료 - 2025-12-13)
